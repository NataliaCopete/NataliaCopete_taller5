...
return -(2*q7)/(pow(4*q7*q7+ eps*eps,3.0/2.0)) ;
...
double w(double q1,double q2,double p2){
 ...
 return ((q1-q2)/pow((pow(q1-q2,2)+eps*eps/4),3.0/2.0))-((q1+q2)/pow((pow(q1+q2,2)+eps*eps/4.0),3.0/2.0));
...
p2=p2+h*1.0/6.0*(kp21+2*kp22+2*kp23+kp24);
